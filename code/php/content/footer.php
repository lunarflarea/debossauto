...
<footer class="page-footer blue-grey darken-1">
     <div class="container">
       <div class="row">
         ...
         <div class="col l2 offset-l1 s12">
           <h5 class="white-text">Nos partenariats</h5>
           <ul>
             <li><a class="grey-text text-lighten-3" href="https://www.debosselage-idf.fr" target="_blank">debosselage-idf.fr</a></li>
           </ul>
     ...
     <div class="footer-copyright">
       <div class="container">
       © 2021 Projets Copyright entreprise Debossauto.fr Ile-de-france
       </figure>
